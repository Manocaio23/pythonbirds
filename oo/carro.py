...
class Direcao:
    ...
    def girar_direita(self):
       self.valor=self.rotacao_a_direita_dct[self.valor]# quando tiver um if else mt grande possivelmente da para trocar por dicionário
...
class Motor:
        ...
        def frear(self):
            ...
            self.velocidade=max(0,self.velocidade)#caso ele entrar em um numero negativo ele retorna 0
